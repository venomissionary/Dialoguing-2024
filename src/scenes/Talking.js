class Talking extends Phaser.Scene {
    ...
    init() {
        ...
        this.TEXT_X = 30			    // text w/in dialog box x-position
    ...
    create() {
        ...
        this.spongebob = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'spongebob').setOrigin(0,1)
        this.coolguy = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'coolguy').setOrigin(0,1)
